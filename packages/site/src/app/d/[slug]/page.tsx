  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="space-y-4">
        ...
        {debate.description && (
          <p className="debate-description text-muted-foreground leading-relaxed">
            {debate.description}
          </p>
        )}

        {/* Sides */}
        <div className="debate-header-card flex items-center gap-4 rounded-lg border p-4">
          <div className="flex-1 text-center">
            ...
            <p className="text-base font-semibold">{debate.sideALabel}</p>
          </div>
          ...
          <div className="flex-1 text-center">
            ...
            <p className="text-base font-semibold">{debate.sideBLabel}</p>
          </div>
        </div>
